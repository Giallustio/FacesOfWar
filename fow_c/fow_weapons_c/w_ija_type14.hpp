	...
	class fow_w_type14 : Pistol_Base_F {
		scope = 2;
		displayName = "[IJA] Type 14";
		model = "fow\fow_weapons\type14\type14";
		picture = "\fow\fow_weapons\type14\data\ui\w_type14_ca.paa";
		...
		hiddenSelectionsTextures[] = {"\fow\fow_weapons\type14\data\type14_co.paa"};
		modes[] = {"Single"};
		...
		class Library
		{
			libTextDesc = "Type 14 Nambu Pistol";
		};
		descriptionShort = "Type 14 Nambu Pistol";
		inertia = 0.1;
