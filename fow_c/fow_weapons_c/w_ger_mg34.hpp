	class fow_w_mg34 : fow_rifle_base {		
		scope = 2;
		displayName = "[GER] MG34";
		model = "fow\fow_weapons\mg34\mg34";
		picture = "\fow\fow_weapons\mg34\data\ui\w_mg34_ca.paa";
		...
		//reloadMagazineSound[] = {"fow\fow_sounds\weapons\mg42\reload_mg34.wav",1.0,1,10};
		drySound[] = {"fow\fow_sounds\weapons\mg34\dry.wav",1,1,20};
		...
		class FullAuto: Mode_FullAuto
		{
			...
			class StandardSound : BaseSoundModeType {
				soundSetShot[] = {"Fow_MG34_Firing", "FoW_MG_EFX", "FoW_Interior_Reverb_MG42"};
			};
