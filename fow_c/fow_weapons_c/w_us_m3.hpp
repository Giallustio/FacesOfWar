	class fow_w_m3 : fow_rifle_base {
		scope = 2;
		displayName = "[US] M3 GreaseGun";
		picture = "\fow\fow_weapons\m3\data\ui\w_m3_ca.paa";
		handAnim[] = {"OFP2_ManSkeleton","\fow\fow_anims\weapons\w_greasegun_hands.rtm"};
		
		model = "fow\fow_weapons\m3\wx_us_m3_greasegun";
		magazines[] = {"fow_30Rnd_45acp","fow_30Rnd_45acp_T"};
		
		reloadAction = "fow_gesture_greasegun_reload";		
		//reloadMagazineSound[] = {"fow\fow_sounds\weapons\m3\reload.wav",1.0,1,10};
		//drySound[] = {"fow\fow_sounds\weapons\m3\dry.wav",0.5011872,1,10};
		...
		class Library {
			libTextDesc = "M3 Grease gun";
		};
		descriptionShort = "M3 Grease gun";
