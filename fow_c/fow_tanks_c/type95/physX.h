...
latency 			= 0.1;
tankTurnForce		= 100000;//330000; /// Random magic number, expected to be something like 11 x mass of vehicle
...
class Wheels {
	class L2 {
		...
		latStiffX = 25;
		latStiffY = 280;
		longitudinalStiffnessPerUnitGravity = 1000;//100000;
		maxBrakeTorque = 15000;
		sprungMass = 2000;
		springStrength = 250234;
		springDamperRate = 24656;
		dampingRate = 1.0;
		dampingRateInAir = 1430.0;
