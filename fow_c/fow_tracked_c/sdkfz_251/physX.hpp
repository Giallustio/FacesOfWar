simulation			= "tankX";
enginePower			= 74;// <Description>: Power of the engine in kW.
maxOmega 			= 277;//maxOmega = (maxRpm*2*Pi)/60.
peakTorque 			= 267;//Maximum engine torque. (=enginePower*1000/maxOmega).
torqueCurve[] 		= {
	{0, 0},
	{(1600/2640), (2650/2850)},
	{(1800/2640), (2800/2850)},
...
class complexGearbox {
	...
	GearboxRatios[]    = {"R2",-3.9,"N",0,"D1",4.7,"D2",3.5,"D3",2.6,"D4",2.0,"D5",1.5,"D6",1.115,"D7",1.05};
...
class Wheels
	{
		class L2
		{
			...
			maxBrakeTorque = 800;
			sprungMass = 650;//750
			springStrength = 65250;//18750//increase to avoid overturn //naturalFrequency * naturalFrequency * sprungMass //Natural freq 5-10 (cars) //tanks * 70-90
			springDamperRate = 6770;//6000//increase to avoid overturn//dampingRatio * 2 * sqrt(springStrength * sprungMass) //dampingRatio 0.8-1.2 (cars)
			dampingRate = 1.0;
			dampingRateInAir = 230.0;
