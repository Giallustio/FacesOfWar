simulation			= "tankX";
enginePower			= 90;// <Description>: Power of the engine in kW.
maxOmega 			= 190;//maxOmega = (maxRpm*2*Pi)/60.
peakTorque 			= 474;//474//Maximum engine torque. (=enginePower*1000/maxOmega).
torqueCurve[] 		= {
	{0, 0},
	{(600/1800), (2650/2850)},
	{(800/1800), (2800/2850)},
...
latency 			= 0.1;
tankTurnForce		= 10000;//330000; /// Random magic number, expected to be something like 11 x mass of vehicle
...
redRpm = 1800; // RPM at which the engine redlines.
...
numberPhysicalWheels = 10;
	class Wheels
	{
		class L2
		{
			...
			maxBrakeTorque = 1500;
			sprungMass = 525;//900
			springStrength = 63000;//53000//increase to avoid overturn
			springDamperRate = 10000;//increase to avoid overturn
			dampingRate = 1.0;
			dampingRateInAir = 420.0;//420
