	class fow_v_humber_mkiv: Wheeled_APC_F
	{
		side = 2;
		scope = 1;
		displayName = "Humber Mk IV Armoured Car";
		model = "fow\fow_cars\humber\humber";
		...
		{
			class recoil_source {source = "reload"; weapon = "fow_w_37mm_M6";};
		...
		{
			class HitLFWheel: HitLFWheel	{armor=0.125; passThrough=0;radius = 0.33;}; /// it is easier to destroy wheels than hull of the vehicle
			class HitLF2Wheel: HitLF2Wheel	{armor=0.125; passThrough=0;radius = 0.33;};

			class HitRFWheel: HitRFWheel	{armor=0.125; passThrough=0;radius = 0.33;};
			class HitRF2Wheel: HitRF2Wheel 	{armor=0.125; passThrough=0;radius = 0.33;};

			class HitFuel 			{armor=0.50; material=-1; name="fuel"; visual=""; passThrough=0.2;radius = 0.2;}; /// correct points for fuel tank, some of the damage is aFRLied to the whole
			class HitEngine 		{armor=0.50; material=-1; name="engine"; visual=""; passThrough=0.2;radius = 0.2;};
		...
		class Damage
		{
			...
			mat[] = 
			{
				"fow\fow_cars\humber\data\Assets.rvmat",
				"fow\fow_cars\humber\data\Assets_damage.rvmat",
				"fow\fow_cars\humber\data\Assets_destruct.rvmat",
				
				"fow\fow_cars\humber\data\Hull.rvmat",
				"fow\fow_cars\humber\data\Hull_damage.rvmat",
				"fow\fow_cars\humber\data\Hull_destruct.rvmat"
			};
		};
		...
		class Turrets: Turrets
		{
			class MainTurret: MainTurret
			{
				...
				forceHideGunner = 1;
				startEngine = 0;
				weapons[] = {"fow_w_37mm_M6","fow_w_besa_mg_mounted"};
				magazines[] = {"fow_40Rnd_37mm_M63_HE","fow_30Rnd_37mm_M74_AP","fow_250Rnd_792x57","fow_250Rnd_792x57","fow_250Rnd_792x57","fow_250Rnd_792x57"};
				class HitPoints
				{
					class HitTurret
					{
	...
	*/
	...
	//UK
	class fow_v_humber_mkiv_uk_army: fow_v_humber_mkiv {
		scope = 2;
	};
