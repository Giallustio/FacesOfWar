	...
	class fow_w_p640p : Pistol_Base_F {
		scope = 2;
		author = "Paul Mr.Rifleman Yakushev";
		model = "\fow\fow_weapons\p640b\p640b.p3d";
		displayName = "[GER] Pistole 640(b)";
		picture = "\fow\fow_weapons\p640b\data\ui\w_p640b_ca.paa";
		...
		class Library
		{
			libTextDesc = "Pistole 640(b)";
		};
		descriptionShort = "P640(b)";
		inertia = 0.1;
