...
idleRPM = 700;
redRPM = 3000;
peakTorque = 4950;//Maximum engine torque. (=enginePower*1000/maxOmega).
torqueCurve[] = {
	{__EVAL(1000/3000)  , __EVAL(3366/4950)},
	{__EVAL(1285/3000)  , __EVAL(3960/4950)},
	{__EVAL(1570/3000)  , __EVAL(4702/4950)},
	{__EVAL(1855/3000)  , __EVAL(4851/4950)},
	{__EVAL(2140/3000)  , __EVAL(4950/4950)},
	{__EVAL(2425/3000)  , __EVAL(4653/4950)},
	{__EVAL(2710/3000)  , __EVAL(3960/4950)},
	{__EVAL(3000/3000)  , __EVAL(3168/4950)}
};
...
{
	GearboxRatios[] = {
		"R1",   -4,		//higher numbers, less power and speed
		"N" ,   0,
		"D1",   4.4,
		"D2",   2.2,
		"D3",   1.5,
	...
	transmissionRatios[]    = {"High",44};        // remaining drivetrain ratios (final drive) //lower more speed -- higher to fit the gear up/down
	gearBoxMode             = "auto";
	moveOffGear             = 1;
	driveString             = "D";
	neutralString           = "N";
...
// ARTIFICIAL FORCES
tankTurnForce           = 240000;               /// Random magic number, expected to be something like 11 x mass of vehicle // initial force applied to turning in [0,tankTurnForceAngMinSpd] ang. speed range
