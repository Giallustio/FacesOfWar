...
*/
		class Sounds
		{
			class Idle_ext
			{
				...
				frequency = "0.95	+	((rpm/	3000) factor[(460/	3000),(865/	3000)])*0.15";
				volume = "engineOn*camPos*(((rpm/	3000) factor[(100/	3000),(200/	3000)])	*	((rpm/	3000) factor[(850/	3000),(700/	3000)]))";
			};
			class Engine
			{
				sound[] = {"fow\fow_tanks\m4a2\Sound\Sherman_Engine04",0.8912509,1,240};
				frequency = "0.8	+	((rpm/	3000) factor[(715/	3000),(1050/	3000)])*0.2";
				volume = "engineOn*camPos*(((rpm/	3000) factor[(720/	3000),(790/	3000)])	*	((rpm/	3000) factor[(950/	3000),(850/	3000)]))";
			};
			class Engine1_ext
			{
				sound[] = {"A3\Sounds_F_EPB\Tracked\engines\engine2\engine_epb_2_ext_3",1.1220185,1,280};
				frequency = "0.8	+	((rpm/	3000) factor[(925/	3000),(1325/	3000)])*0.2";
				volume = "engineOn*camPos*(((rpm/	3000) factor[(830/	3000),(940/	3000)])	*	((rpm/	3000) factor[(1380/	3000),(1000/	3000)]))";
			};
			class Engine2_ext
			{
				sound[] = {"A3\Sounds_F_EPB\Tracked\engines\engine2\engine_epb_2_ext_4",1.2589254,1,320};
				frequency = "0.8	+	((rpm/	3000) factor[(1110/	3000),(1730/	3000)])*0.2";
				volume = "engineOn*camPos*(((rpm/	3000) factor[(950/	3000),(1100/	3000)])	*	((rpm/	3000) factor[(1730/	3000),(1250/	3000)]))";
			};
			class Engine3_ext
			{
				sound[] = {"A3\Sounds_F_EPB\Tracked\engines\engine2\engine_epb_2_ext_5",1.4125376,1,360};
				frequency = "0.8	+	((rpm/	3000) factor[(1380/	3000),(1965/	3000)])*0.1";
				volume = "engineOn*camPos*(((rpm/	3000) factor[(1250/	3000),(1450/	3000)])	*	((rpm/	3000) factor[(1965/	3000),(1560/	3000)]))";
			};
			class Engine4_ext
			{
				sound[] = {"A3\Sounds_F_EPB\Tracked\engines\engine2\engine_epb_2_ext_6",1.5848932,1,460};
				frequency = "0.8	+	((rpm/	3000) factor[(1865/	3000),(2650/	3000)])*0.1";
				volume = "engineOn*camPos*(((rpm/	3000) factor[(1570/	3000),(1670/	3000)])	*	((rpm/	3000) factor[(2200/	3000),(1900/	3000)]))";
			};
			class Engine5_ext
			{
				sound[] = {"A3\Sounds_F_EPB\Tracked\engines\engine2\engine_epb_2_ext_7",1.7782794,1,440};
				frequency = "0.8	+	((rpm/	3000) factor[(1925/	3000),(2650/	3000)])*0.1";
				volume = "engineOn*camPos*((rpm/	3000) factor[(1950/	3000),(2170/	3000)])";
			};
			class IdleThrust
			{
				sound[] = {"A3\Sounds_F_EPB\Tracked\engines\engine2\exhaust_epb_2_ext_1",1.1220185,1,200};
				frequency = "0.8	+	((rpm/	3000) factor[(460/	3000),(865/	3000)])*0.15";
				volume = "engineOn*camPos*(0.4+(0.6*(thrust factor[0.1,1])))*(((rpm/	3000) factor[(100/	3000),(200/	3000)])	*	((rpm/	3000) factor[(850/	3000),(700/	3000)]))";
			};
			class EngineThrust
			{
				sound[] = {"A3\Sounds_F_EPB\Tracked\engines\engine2\exhaust_epb_2_ext_2",1.4125376,1,200};
				frequency = "0.8	+	((rpm/	3000) factor[(715/	3000),(1050/	3000)])*0.2";
				volume = "engineOn*camPos*(0.4+(0.6*(thrust factor[0.1,1])))*(((rpm/	3000) factor[(720/	3000),(790/	3000)])	*	((rpm/	3000) factor[(950/	3000),(850/	3000)]))";
			};
			class Engine1_Thrust_ext
			{
				sound[] = {"A3\Sounds_F_EPB\Tracked\engines\engine2\exhaust_epb_2_ext_3",1.7782794,1,230};
				frequency = "0.8	+	((rpm/	3000) factor[(925/	3000),(1325/	3000)])*0.2";
				volume = "engineOn*camPos*(0.4+(0.6*(thrust factor[0.1,1])))*(((rpm/	3000) factor[(830/	3000),(940/	3000)])	*	((rpm/	3000) factor[(1380/	3000),(1000/	3000)]))";
			};
			class Engine2_Thrust_ext
			{
				sound[] = {"A3\Sounds_F_EPB\Tracked\engines\engine2\exhaust_epb_2_ext_4",1.9952624,1,290};
				frequency = "0.8	+	((rpm/	3000) factor[(1110/	3000),(1730/	3000)])*0.2";
				volume = "engineOn*camPos*(0.4+(0.6*(thrust factor[0.1,1])))*(((rpm/	3000) factor[(950/	3000),(1100/	3000)])	*	((rpm/	3000) factor[(1730/	3000),(1250/	3000)]))";
			};
			class Engine3_Thrust_ext
			{
				sound[] = {"A3\Sounds_F_EPB\Tracked\engines\engine2\exhaust_epb_2_ext_5",1.7782794,1,350};
				frequency = "0.8	+	((rpm/	3000) factor[(1380/	3000),(1965/	3000)])*0.1";
				volume = "engineOn*camPos*(0.4+(0.6*(thrust factor[0.1,1])))*(((rpm/	3000) factor[(1250/	3000),(1450/	3000)])	*	((rpm/	3000) factor[(1965/	3000),(1560/	3000)]))";
			};
			class Engine4_Thrust_ext
			{
				sound[] = {"A3\Sounds_F_EPB\Tracked\engines\engine2\exhaust_epb_2_ext_6",2.2387211,1,460};
				frequency = "0.8	+	((rpm/	3000) factor[(1865/	3000),(2650/	3000)])*0.1";
				volume = "engineOn*camPos*(0.4+(0.6*(thrust factor[0.1,1])))*(((rpm/	3000) factor[(1570/	3000),(1670/	3000)])	*	((rpm/	3000) factor[(2200/	3000),(1900/	3000)]))";
			};
			class Engine5_Thrust_ext
			{
				sound[] = {"A3\Sounds_F_EPB\Tracked\engines\engine2\exhaust_epb_2_ext_7",2.5118864,1,450};
				frequency = "0.8	+	((rpm/	3000) factor[(1925/	3000),(2650/	3000)])*0.1";
				volume = "engineOn*camPos*(0.4+(0.6*(thrust factor[0.1,1])))*((rpm/	3000) factor[(1950/	3000),(2170/	3000)])";
			};
			class Idle_int
			{
				sound[] = {"A3\Sounds_F_EPB\Tracked\engines\engine2\engine_epb_2_int_1",0.5011872,1};
				frequency = "0.8	+	((rpm/	3000) factor[(460/	3000),(865/	3000)])*0.15";
				volume = "engineOn*(1-camPos)*(((rpm/	3000) factor[(100/	3000),(200/	3000)])	*	((rpm/	3000) factor[(850/	3000),(700/	3000)]))";
			};
			class Engine_int
			{
				sound[] = {"A3\Sounds_F_EPB\Tracked\engines\engine2\engine_epb_2_int_2",0.3548134,1};
				frequency = "0.8	+	((rpm/	3000) factor[(715/	3000),(1050/	3000)])*0.2";
				volume = "engineOn*(1-camPos)*(((rpm/	3000) factor[(720/	3000),(790/	3000)])	*	((rpm/	3000) factor[(950/	3000),(850/	3000)]))";
			};
			class Engine1_int
			{
				sound[] = {"A3\Sounds_F_EPB\Tracked\engines\engine2\engine_epb_2_int_3",0.39810717,1};
				frequency = "0.8	+	((rpm/	3000) factor[(925/	3000),(1325/	3000)])*0.2";
				volume = "engineOn*(1-camPos)*(((rpm/	3000) factor[(830/	3000),(940/	3000)])	*	((rpm/	3000) factor[(1380/	3000),(1000/	3000)]))";
			};
			class Engine2_int
			{
				sound[] = {"A3\Sounds_F_EPB\Tracked\engines\engine2\engine_epb_2_int_4",0.4466836,1};
				frequency = "0.8	+	((rpm/	3000) factor[(1110/	3000),(1730/	3000)])*0.2";
				volume = "engineOn*(1-camPos)*(((rpm/	3000) factor[(950/	3000),(1100/	3000)])	*	((rpm/	3000) factor[(1730/	3000),(1250/	3000)]))";
			};
			class Engine3_int
			{
				sound[] = {"A3\Sounds_F_EPB\Tracked\engines\engine2\engine_epb_2_int_5",0.5011872,1};
				frequency = "0.8	+	((rpm/	3000) factor[(1380/	3000),(1965/	3000)])*0.1";
				volume = "engineOn*(1-camPos)*(((rpm/	3000) factor[(1250/	3000),(1450/	3000)])	*	((rpm/	3000) factor[(1965/	3000),(1560/	3000)]))";
			};
			class Engine4_int
			{
				sound[] = {"A3\Sounds_F_EPB\Tracked\engines\engine2\engine_epb_2_int_6",0.56234133,1};
				frequency = "0.8	+	((rpm/	3000) factor[(1865/	3000),(2650/	3000)])*0.1";
				volume = "engineOn*(1-camPos)*(((rpm/	3000) factor[(1570/	3000),(1670/	3000)])	*	((rpm/	3000) factor[(2200/	3000),(1900/	3000)]))";
			};
			class Engine5_int
			{
				sound[] = {"A3\Sounds_F_EPB\Tracked\engines\engine2\engine_epb_2_int_7",0.63095737,1};
				frequency = "0.8	+	((rpm/	3000) factor[(1925/	3000),(2650/	3000)])*0.1";
				volume = "engineOn*(1-camPos)*((rpm/	3000) factor[(1950/	3000),(2170/	3000)])";
			};
			class IdleThrust_int
			{
				sound[] = {"A3\Sounds_F_EPB\Tracked\engines\engine2\exhaust_epb_2_int_1",0.63095737,1};
				frequency = "0.8	+	((rpm/	3000) factor[(460/	3000),(865/	3000)])*0.15";
				volume = "engineOn*(1-camPos)*(0.4+(0.6*(thrust factor[0.1,1])))*(((rpm/	3000) factor[(100/	3000),(200/	3000)])	*	((rpm/	3000) factor[(850/	3000),(700/	3000)]))";
			};
			class EngineThrust_int
			{
				sound[] = {"A3\Sounds_F_EPB\Tracked\engines\engine2\exhaust_epb_2_int_2",0.39810717,1};
				frequency = "0.8	+	((rpm/	3000) factor[(715/	3000),(1050/	3000)])*0.2";
				volume = "engineOn*(1-camPos)*(0.4+(0.6*(thrust factor[0.1,1])))*(((rpm/	3000) factor[(720/	3000),(790/	3000)])	*	((rpm/	3000) factor[(950/	3000),(850/	3000)]))";
			};
			class Engine1_Thrust_int
			{
				sound[] = {"A3\Sounds_F_EPB\Tracked\engines\engine2\exhaust_epb_2_int_3",0.4466836,1};
				frequency = "0.8	+	((rpm/	3000) factor[(925/	3000),(1325/	3000)])*0.2";
				volume = "engineOn*(1-camPos)*(0.4+(0.6*(thrust factor[0.1,1])))*(((rpm/	3000) factor[(830/	3000),(940/	3000)])	*	((rpm/	3000) factor[(1380/	3000),(1000/	3000)]))";
			};
			class Engine2_Thrust_int
			{
				sound[] = {"A3\Sounds_F_EPB\Tracked\engines\engine2\exhaust_epb_2_int_4",0.4466836,1};
				frequency = "0.8	+	((rpm/	3000) factor[(1110/	3000),(1730/	3000)])*0.2";
				volume = "engineOn*(1-camPos)*(0.4+(0.6*(thrust factor[0.1,1])))*(((rpm/	3000) factor[(950/	3000),(1100/	3000)])	*	((rpm/	3000) factor[(1730/	3000),(1250/	3000)]))";
			};
			class Engine3_Thrust_int
			{
				sound[] = {"A3\Sounds_F_EPB\Tracked\engines\engine2\exhaust_epb_2_int_5",0.5011872,1};
				frequency = "0.8	+	((rpm/	3000) factor[(1380/	3000),(1965/	3000)])*0.1";
				volume = "engineOn*(1-camPos)*(0.4+(0.6*(thrust factor[0.1,1])))*(((rpm/	3000) factor[(1250/	3000),(1450/	3000)])	*	((rpm/	3000) factor[(1965/	3000),(1560/	3000)]))";
			};
			class Engine4_Thrust_int
			{
				sound[] = {"A3\Sounds_F_EPB\Tracked\engines\engine2\exhaust_epb_2_int_6",0.56234133,1};
				frequency = "0.8	+	((rpm/	3000) factor[(1865/	3000),(2650/	3000)])*0.1";
				volume = "engineOn*(1-camPos)*(0.4+(0.6*(thrust factor[0.1,1])))*(((rpm/	3000) factor[(1570/	3000),(1670/	3000)])	*	((rpm/	3000) factor[(2200/	3000),(1900/	3000)]))";
			};
			class Engine5_Thrust_int
			{
				sound[] = {"A3\Sounds_F_EPB\Tracked\engines\engine2\exhaust_epb_2_int_7",0.63095737,1};
				frequency = "0.8	+	((rpm/	3000) factor[(1925/	3000),(2650/	3000)])*0.1";
				volume = "engineOn*(1-camPos)*(0.4+(0.6*(thrust factor[0.1,1])))*((rpm/	3000) factor[(1950/	3000),(2170/	3000)])";
			};
			class NoiseInt
			{
