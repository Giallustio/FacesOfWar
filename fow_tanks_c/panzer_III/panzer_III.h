	...
	class fow_v_panzer_III: Tank_F {
		displayName = "Sd.Kfz. 141 Panzer III Ausf. G";
		model = "\fow\fow_tanks\panzer_III\panzer3g";
		faction = "fow_heer";
		...
		{
			class gun_1_recoil_cannon {source = "reload";weapon = "fow_w_50mm_kwk38_l42";};
		...
		class Library
		{
			libTextDesc = "Sd.Kfz. 141 Panzer III Ausf. G";
		};
		...
		class Damage
		{
			tex[] = {};
			mat[] = {
				"fow\fow_tanks\panzer_III\data\PZ_III_Hull01.rvmat",
				"fow\fow_tanks\panzer_III\data\PZ_III_Hull01_damage.rvmat",
				"fow\fow_tanks\panzer_III\data\PZ_III_Hull01_destruct.rvmat",
				
				"fow\fow_tanks\panzer_III\data\PZ_III_Hull02.rvmat",
				"fow\fow_tanks\panzer_III\data\PZ_III_Hull02_damage.rvmat",
				"fow\fow_tanks\panzer_III\data\PZ_III_Hull02_destruct.rvmat",
				
				"fow\fow_tanks\panzer_III\data\PZ_III_turret.rvmat",
				"fow\fow_tanks\panzer_III\data\PZ_III_turret_damage.rvmat",
				"fow\fow_tanks\panzer_III\data\PZ_III_turret_destruct.rvmat",
				
				"fow\fow_tanks\panzer_III\data\PZ_III_Wheels.rvmat",
				"fow\fow_tanks\panzer_III\data\PZ_III_Wheels_damage.rvmat",
				"fow\fow_tanks\panzer_III\data\PZ_III_Wheels_destruct.rvmat"
			...
			class MainTurret: MainTurret
			{
				class Turrets: Turrets
				{
					...
					class HullGunner: CommanderOptics
					{
						...
						magazines[] = {"fow_200Rnd_792x57","fow_200Rnd_792x57","fow_200Rnd_792x57","fow_200Rnd_792x57","fow_200Rnd_792x57","fow_200Rnd_792x57","fow_200Rnd_792x57","fow_200Rnd_792x57","fow_200Rnd_792x57"};
						visionMode[] = {"Normal"};
						discreteInitIndex = 2;
				...
				maxHorizontalRotSpeed = 1.2;//maxHorizontalRotSpeed = "((360/X)/45)";//The first Panthers (Ausf D) had a hydraulic motor that could traverse the turret at a maximum rate of one complete revolution in one minute, independent of engine speed. This was improved in the Ausf A model with a hydraulic traverse that varied with engine speed; one full turn taking 46 seconds at an engine speed of 1,000 rpm but only 15 seconds if the engine was running at 3,000 rpm
				...
				gunnerGetInAction = "GetInLow";
				gunnerGetOutAction = "GetOutLow";
				weapons[] = {"fow_w_50mm_kwk38_l42","fow_w_mg34_mounted_t_1"};
				magazines[] = {"fow_30Rnd_50mm_pzgr39_APCBC","fow_20Rnd_50mm_pzgr40_APCR","fow_34Rnd_50mm_sprg34_HE","fow_200Rnd_792x57","fow_200Rnd_792x57","fow_200Rnd_792x57","fow_200Rnd_792x57","fow_200Rnd_792x57","fow_200Rnd_792x57","fow_200Rnd_792x57","fow_200Rnd_792x57","fow_200Rnd_792x57"};
	...
	class fow_v_panzer_III_G_ger_heer: fow_v_panzer_III {
		scope = 2;
		displayName = "Sd.Kfz. 141 Panzer III Ausf. G";
	};
