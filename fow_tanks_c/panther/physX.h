...
class Wheels
{
	class L2
	{
		...
		maxBrakeTorque = 5000;
		sprungMass = -1;
		springStrength = 18750;//18750/262500/increase to avoid overturn //naturalFrequency * naturalFrequency * sprungMass //Natural freq 5-10 (cars) //tanks * 70-90
		springDamperRate = 6000;//6000/62750/increase to avoid overturn//dampingRatio * 2 * sqrt(springStrength * sprungMass) //dampingRatio 0.8-1.2 (cars)
		dampingRate = 1.0;
