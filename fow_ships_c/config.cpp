class cfgPatches
{
	class fow_ships	{
		...
		units[] =
		{
			...
			"fow_v_m_AttackTransport_Bow",
			"fow_v_m_AttackTransport_Bow_helper",
			"fow_v_m_AttackTransport_Stern",
			"fow_v_m_AttackTransport_Stern_helper",
			"fow_v_m_portside_ladder",
			"fow_v_m_starboard_ladder"/*,
			"fow_v_carrier_test",
...
class CfgFunctions {
	class fow_ships_functions {
		tag = "fow_ships";
		class fow_functions {
			file = "fow\fow_ships_c\fnc";
			class attacktransport_init;
		};
	};
};
...
/*	class StaticWeapon: LandVehicle{};
	...
	class fow_v_m_portside_ladder: fow_v_m_attacktransportladder
	{
		displayName = "wx_portside_ladder";
		model = "\fow\fow_ships\attacktransport\wx_portside_ladder.p3d";
	};

	class fow_v_m_starboard_ladder: fow_v_m_attacktransportladder
	{
		displayName = "starboard_ladder";
		model = "\fow\fow_ships\attacktransport\wx_starboard_ladder.p3d";
	};

	class fow_v_m_portside_ladder_long: fow_v_m_portside_ladder
	{
		displayName = "wx_portside_ladder_long";
		model = "\fow\fow_ships\attacktransport\wx_portside_ladder_long.p3d";
	};

	class fow_v_m_starboard_ladder_long: fow_v_m_portside_ladder_long
	{
		displayName = "wx_starboard_ladder_long";
		reversed = 1;
	};

	class fow_v_m_portside_netting: fow_v_m_attacktransportladder
	{
		displayName = "wx_portside_netting";
		model = "\fow\fow_ships\attacktransport\wx_portside_netting.p3d";
		ladders[]=
		{
			{"start_01","end_01",5,"start_3"},
			{"start_02","end_02",5,"start_3"},
			{"start_03","end_03",5,"start_2"},
			{"start_04","end_04",5,"start_2"},
			{"start_05","end_05",5,"start_2"},
			{"start_06","end_06",5,"start_1"},
			{"start_07","end_07",5,"start_1"}
		};
	};

	class fow_v_m_starboard_netting: fow_v_m_portside_netting
	{
...
/*		ACRE_hasRack = 1;
		...
		class EventHandlers
		{
			...
			init = "[_this select 0] execVM ""\fow\fow_ships_c\fnc\fn_attacktransport_init.sqf""; ";
		};
